...
# La opción `text`no se modifica.
  ...
  #     text: "{{< fa envelope >}} Email"
    - href: https://scienti.minciencias.gov.co/cvlac/visualizador/generarCurriculoCv.do?cod_rh=0000058068
      text: "{{< ai cv >}} CvLAC"
  #   - href: https://scholar.google.com/citations?user=lOgHTMAAAAAJ
  #     text: "{{< ai google-scholar >}} Google Scholar"
    - href: https://orcid.org/0000-0002-8218-8136
      text: "{{< ai orcid >}} ORCID"
...
-   **Universidade de São Paulo** \| São Paulo, Brasil\
    Doctorado en Ciencias (Botánica) \| 1980-1985\
    Palinotaxonomia da família Myrsinaceae R. Br. no Brasil

-   **Universidad de Antioquia** \| Medellín, Colombia\
    Pregrado en Biología \| 1967-1972\
    Polen: diversidad en formas y tamaños
