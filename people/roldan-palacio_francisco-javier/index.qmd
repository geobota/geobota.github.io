...
title: &title "**Francisco Javier Roldán-Palacio**"
...
# La opción `text`no se modifica.
  ...
  #     text: "{{< fa envelope >}} Email"
    - href: https://scienti.minciencias.gov.co/cvlac/visualizador/generarCurriculoCv.do?cod_rh=0000104280
      text: "{{< ai cv >}} CvLAC"
  ...
  #     text: "{{< ai orcid >}} ORCID"
    - href: https://www.researchgate.net/profile/Francisco-Roldan-Palacio
...
-   **Universidad de Antioquia** \| Medellín, Colombia\
    Pregrado en Biología \| 1981-1993\
    Contribución al conocimiento de las Lorantáceas en el departamento de Antioquia
